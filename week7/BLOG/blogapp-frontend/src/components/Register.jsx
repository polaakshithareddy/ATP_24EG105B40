      ...
      <div className={formCard}>
        ...
        <form onSubmit={handleSubmit(onUserRegister)}>
          ...
          <div className={formGroup}>
            ...
            <input 
              type="file" 
              className="w-full text-sm text-[#6e6e73] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-[#e8e8ed] file:text-[#1d1d1f] hover:file:bg-[#d2d2d7] file:cursor-pointer cursor-pointer transition-colors" 
